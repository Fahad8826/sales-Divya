      ...
      appBar: AppBar(
        ...
        actions: [
          RawMaterialButton(
            ...
            child: const Icon(Icons.call, size: 30.0, color: Colors.white),
          ),
        ],
      ),
      body: Obx(() {
...
//   late final LeadDetailsController controller;

//   @override
//   void initState() {
//     super.initState();
//     // Register or find the controller
//     if (Get.isRegistered<LeadDetailsController>()) {
//       controller = Get.find<LeadDetailsController>();
//     } else {
//       controller = Get.put(LeadDetailsController(leadId: widget.leadId));
//     }
//   }
...
//                                 final result = await controller.saveLead();
//                                 if (result) {
//                                   Get.snackbar(
//                                     "Success",
...
//                                       Get.snackbar(
//                                         "Error",
//                                         "Error placing order. Please check all fields.",
//                                         backgroundColor: Colors.red[100],
//                                       );
//                                     }
//                                   }
