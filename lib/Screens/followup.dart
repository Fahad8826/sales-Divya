...
import 'package:sales/Controller/followup_controller.dart';
import 'package:sales/Screens/home.dart';
import 'package:sales/Screens/individual_follow_up.dart';
...
class FollowupPage extends StatelessWidget {
  ...
  Widget _buildListTile(
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(16),
          onTap: () => _navigateToDetails(data, 'Lead', docId),
          child: Padding(
  ...
  void _navigateToDetails(
    ...
    Get.to(() => IndividualFollowUp(data: data, type: type, docId: docId));
  }
        ...
        return Obx(() {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildListTile(data, lead.id, controller, size, isTablet);
            },
          );
        });
      },
